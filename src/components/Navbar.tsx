...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 w-full z-50 h-20 flex items-center justify-between px-6 md:px-12 transition-all duration-300 ${scrolled ? 'bg-background/80 backdrop-blur-md' : 'bg-background/20 backdrop-blur-sm'}`}>
        {/* Desktop left links */}
